...
FastAPI メインエントリーポイント（相対インポート無し版）
"""
...
from src.controllers.contact_controller import router as contact_router
from src.controllers.alerts_controller import router as alerts_router
